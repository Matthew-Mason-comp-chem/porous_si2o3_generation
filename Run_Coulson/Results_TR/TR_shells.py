...
for T in range(1000,5001, 100):
    ...
    for S in range(0,150,1):
        ...
        if os.path.exists('TR_SHELLS/results_{:}_{:}_shell.dat'.format(T,S)):
            print("skipping")
            continue
...
####                            plt.scatter(old_crd[0], old_crd[1], color=color_list[shell-1], marker='x')
####                            plt.scatter(new_crd[0], new_crd[1], color=color_list[shell])
####                            plt.plot([old_crd[0], new_crd[0]], [old_crd[1], new_crd[1]], color='r')
#                dual['{:}'.format(i)] = {}
